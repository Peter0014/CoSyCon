...
public class TimelineActivity extends AppCompatActivity {
    ...
    private void initializeVariables() {
        ...
        toolbar = (Toolbar) findViewById(R.id.timeline_bottom_navigation_bar);
        setSupportActionBar(toolbar);

        // Set BottomNavigationBar
        bottomNavigationBar = (BottomNavigationBar) findViewById(R.id.timeline_bottom_navigation_bar);
        ...
        fab = (FloatingActionButton) findViewById(R.id.timeline_fab);
